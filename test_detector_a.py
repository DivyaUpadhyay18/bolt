...
print(f"DETECTOR A: Extra Wide Color Ranges, 2+ colors, 2+ frames")
...
# EXTRA wide color ranges
color_ranges = {
    'purple': [(90, 0, 0), (185, 255, 255)],      # Even wider purple
    'red': [(0, 15, 15), (50, 255, 255)],         # Even wider red
    'gray': [(0, 0, 15), (180, 170, 225)]         # Even wider gray
}
...
def get_clusters(frame):
    ...
    for contour in contours:
        ...
        aspect_ratio = w / h
        if aspect_ratio < 0.32 or aspect_ratio > 3.1:
            continue
...
print(f"\n{'='*60}")
print(f"DETECTOR A RESULT: {len(final_holes)} HOLES")
print(f"{'='*60}\n")
