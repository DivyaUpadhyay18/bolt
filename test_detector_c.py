...
print(f"DETECTOR C: Lower Proximity Threshold (50px), 2+ colors, 2+ frames")
print(f"Processing {frame_count} frames...\n")

hole_tracks = {}
next_hole_id = 1
proximity_threshold = 50  # TIGHTER spatial separation
...
print(f"\n{'='*60}")
print(f"DETECTOR C RESULT: {len(final_holes)} HOLES")
print(f"{'='*60}\n")
